...
const IntegratedOfferings: React.FC = () => {
  ...
  const offerings = [
    ...
    },
    {
      ...
      description:
        "Multi-stakeholder events, bridging programs, workshops, facilitated dialogues, peer-to-peer learning, technical capacity building",
      whatWeDo: [
    ...
    },
    {
      ...
      description:
        "Impact assessments, baseline/endline/midline studies, participatory analysis, social audit advisory, policy monitoring, MERL design, MEL system building",
      whatWeDo: [
    ...
    },
    {
      ...
      description:
        "CSR strategy development, ecosystem mapping, alliance architecture, program design, inclusive governance, foundations, trust building",
      whatWeDo: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            Working cognately across all problems to enable system-wide impact
            and multiply impact
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {offerings.map((offering, index) => (
            ...
            >
              {/* Icon */}
              <div
                className={`${offering.iconBg} w-16 h-16 rounded-xl flex items-center justify-center text-3xl mb-6 transition-transform duration-300 hover:scale-110`}
              >
                {offering.icon}
              </div>

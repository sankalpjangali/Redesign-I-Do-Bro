...
const ResourceNews: React.FC = () => {
  return (
    <section id="resources" className="relative  h-[100%] lg:h-[80%] bg-gradient-to-br from-purple-600 to-blue-300 pt-20 pd-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white bg-opacity-40 rounded-lg shadow-lg p-6 hover:bg-opacity-50 transition-all duration-300">
            <img src="/path/to/image.jpg" alt="News Title 1" />

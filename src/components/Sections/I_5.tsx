...
const MultiplierModel: React.FC = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "INTERFACE",
      description:
        "Build channels for collaboration and structured communication",
    ...
    },
    {
      ...
      title: "INTEGRATE",
      description:
        "Align strategies, resources, and implement coordinated solutions",
    ...
    },
    {
      ...
      title: "IMPACT",
      description:
        "Measure outcomes, ensure sustainability, and long-term ownership",
      items: ["MEAL", "Sustainability planning", "Impact measurement"],
      timeline: "Ongoing",
      color: "indigo",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            I*5 is our Theory of Change (Change from Model)
          </h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            I*5 is the process of scaling initiative to multiply impact and
            build ecosystems through a deeper model of engagement and assessment
          </p>
        </div>

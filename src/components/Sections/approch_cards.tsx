  ...
  const cards = [
    {
      ...
      description: 'Learn about our systems thinking framework, RISE values, and how we multiply impact',
    ...
    },
    {
      ...
      description: 'Discover how we can work together to multiply your social impact',
    ...
    },
    {
      ...
      description: 'Explore KORU, RISE World Summit, and our circular economy programs',

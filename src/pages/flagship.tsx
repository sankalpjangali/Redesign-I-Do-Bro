...
const FlagshipInitiativesPage: React.FC = () => {
  ...
  const initiatives = [
    ...
    },
    {
      ...
      description:
        "A comprehensive circular economy initiative that promotes repair, reuse, and recycling. Go! Go! Go!u engages community members to convert waste into value through decentralized micro-entrepreneurship, creating sustainable green jobs.",
      image:
    ...
    },
    {
      ...
      description:
        "An annual, global convening bringing together social impact leaders, entrepreneurs, corporates, and policymakers from around the world to address SDG solutions, WSGE initiatives, funding opportunities, and collective collaboration agendas.",
      image:
      ...
      <section className="py-16 px-6 bg-white">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            Signature programs that demonstrate our commitment to systems-level
            <br />
          ...
          {initiatives.map((initiative, index) => (
            ...
            >
              ...
              >
                {/* Content Side */}
                <div
                  className={`${index % 2 === 1 ? "md:order-2" : ""} bg-white rounded-2xl p-8 shadow-sm`}
                >
                  {/* <span
                    className={`inline-block px-3 py-1 ${initiative.tagColor} rounded-full text-xs font-medium mb-4`}
                  >
                    {initiative.tag}
                  </span> */}
                  ...
                  {/* Button */}
                  {/* <button
                    className={`px-6 py-2 ${initiative.buttonColor} text-white rounded-full text-sm font-medium transition-colors`}
                  >
      ...
      <section className="py-20 px-6 bg-white">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-8">
            Join us in creating systems-level change through innovative programs
            <br />

  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Load testimonials
        const testimonialsResponse = await fetch('/data/idobro_partnership_partner_voices.json');
        const testimonialsData = await testimonialsResponse.json();
        setTestimonials(testimonialsData.testimonials || []);
        // Load partners
        const partnersResponse = await fetch('/data/idobro_partners.json');
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="pt-8"
          >
            <button className="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-2xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Our Partnership <span className="text-blue-600">Methodology</span>
          </h2>
  ...
  return (
    <div className="py-20 bg-white" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Partnership <span className="text-blue-600">Success Stories</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
    ...
    >
      ...
      >
        ...
        <div className="space-y-6">
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-2">Partner</h4>
            <p className="text-gray-700">{project.partner}</p>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-2">Timeline</h4>
            <p className="text-gray-700">{project.timeline}</p>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-2">Project Details</h4>
            <p className="text-gray-700">{project.project_details}</p>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-2">Idobro's Role</h4>
            <p className="text-gray-700">{project.idobro_role}</p>
          </div>
          
          <div>
            <h4 className="text-lg font-semibold text-blue-600 mb-2">Outcomes</h4>
  ...
  return (
    <div className="py-20 bg-gradient-to-br from-blue-50 to-purple-50" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Partner <span className="text-blue-600">Voices</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Let's Create <span className="text-blue-400">Impact Together</span>
          </h2>

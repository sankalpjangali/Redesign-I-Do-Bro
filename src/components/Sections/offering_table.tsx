  ...
  const programs = [
    {
      ...
      description:
        "Leveraging digital platforms and communication strategies to amplify the reach and impact of social initiatives.",
      icon: "☁️",
      features: [
    ...
    },
    {
      ...
      description:
        "Creating platforms for meaningful dialogue, collaboration, and partnerships across sectors.",
      icon: "🔄",
      features: [
    ...
    },
    {
      title: "Idobro RISE",
      subtitle:
        "Frameworks to design appropriate CSR projects and Development interventions",
      description:
        "Implementing value-driven frameworks for responsible, inclusive, sustainable, and eco-friendly development.",
      icon: "📈",
      features: [
  ...
  const approaches = [
    {
      ...
      description:
        "Empowering individuals and students to become agents of positive change in their communities.",
      icon: "👤",
    ...
    },
    {
      ...
      description:
        "Supporting Women, Social and Green Enterprises (WSGE) to start, sustain, and scale their impact.",
      icon: "🚀",
    ...
    },
    {
      ...
      description:
        "Facilitating collaborations across government, industry, academia, and civil society for systemic change.",
      icon: "🤝",
      ...
      <section className="py-20 w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white">
        ...
        >
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Partner with us to multiply opportunities and create sustainable

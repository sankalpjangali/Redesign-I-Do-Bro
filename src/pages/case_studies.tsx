  ...
  const caseStudies = [
    {
      ...
      description: 'The Mahesh Wadhwa Foundation partnered with Mahaeconet, coordinating 90% organizations across 7 districts, fast-dial strong, 25-30x lift turnaround.',
      challenge: 'Post-disaster chaos and a fractured CSO ecosystem needed centralized communications working in sync, redeploying efforts, and ensuring collaboration.',
      solution: 'Built a digital dashboard to unify stakeholder platform ensuring high-level government connection, INGO networks, and collaboration across diverse stakeholder categories.',
    ...
    },
    {
      ...
      subtitle: 'To foster eco-responsible health practices and climate-friendly drug studies',
      description: 'A long-term partnership demonstrating how consistent, integrated support can transform community health and livelihoods while reducing carbon footprints.',
      challenge: 'Their organization was dedicated to eco-efficient health infrastructure development, challenges included hospital infrastructure intervention, improved solar installations and better medication supply.',
      solution: 'Developed and implemented an integrated program combining health operations, distributed network and sustainable building with 11 years of continuous collaboration.',
      ...
      <section className="py-16 px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            Real-world examples of how our systems approach creates lasting,<br />
            ...
            >
              <div className={`grid md:grid-cols-2 gap-8 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                ...
                <div className={index % 2 === 1 ? 'md:order-2' : ''}>
                  ...
                  {/* The Challenge */}
                  <div className="mb-6">
                    <h3 className="text-red-600 font-semibold mb-2">The Challenge</h3>
      ...
      <section className="py-20 px-6 bg-gray-50">
        ...
        >
          ...
          <p className="text-lg text-gray-600 mb-8">
            Partner with us to design and implement programs that create lasting, measurable<br />

...
type ContentType = "Blogs" | "News" | "Reports" | "Citizenship_Program" | "Team"| "Citizenship_stories"|"Partners"|"Partners_voice"|"Partnership_success"|"Live_news" ;
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <nav className="flex space-x-4 border-b mb-6  overflow-x-auto whitespace-nowrap scrollbar-hide">
          {(["Blogs", "News", "Reports", "Citizenship_Program","Team","Citizenship_stories","Partners","Partners_voice","Partnership_success","Live_news"] as ContentType[]).map((tab) => (
            <button
              key={tab}

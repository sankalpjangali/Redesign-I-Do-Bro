...
import { Lightbulb, Users, Calendar, Building2, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Building awareness and active participation in social and environmental causes
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div
          ...
          className={`transition-all duration-700 ${
            isVisible('citizenship-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        >
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-12">
            ...
            {citizenshipMeanings.map((item, index) => (
              <div 
                ...
                className={`mb-6 flex items-start transition-all duration-700 ${
                  isVisible(`meaning-${index}`) ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'
                }`}
                style={{ transitionDelay: `${index * 100}ms` }}
              >
          ...
          <div 
            ...
            className={`bg-green-50 rounded-lg p-8 transition-all duration-700 ${
              isVisible('multiplier') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'
            }`}
          >
        ...
        <div className="max-w-6xl mx-auto">
          <div
            ...
            className={`text-center mb-12 transition-all duration-700 ${
              isVisible('programs-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          >
            <h2 className="text-3xl font-bold text-gray-900 mb-4">How We Engage Citizenship</h2>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div
          ...
          data-animate
          className={`text-center mb-12 transition-all duration-700 ${
            isVisible('focus-header') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        >
          ...
          {focusAreas.map((area, index) => (
            <div 
              ...
              className={`bg-green-50 rounded-lg p-6 text-center hover:bg-green-100 transition-all duration-700 ${
                isVisible(`focus-${index}`) ? 'opacity-100 scale-100' : 'opacity-0 scale-90'
              }`}
              style={{ transitionDelay: `${index * 100}ms` }}
            >

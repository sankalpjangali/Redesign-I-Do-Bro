          ...
          <div data-aos="fade-up" className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
                <span className="text-purple-600 block"> Citizenship</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="#services"
                className="inline-flex items-center justify-center px-8 py-4 border-2 border-blue-600 text-purple-600 font-semibold rounded-lg hover:bg-blue-50 transition-colors"
              >
                Explore Programs
              </a>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600">58,525</div>
                <div className="text-sm text-gray-600">Beneficiaries</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-600">795</div>

      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We welcome you to visit our office in Mumbai. Schedule an
            appointment or drop by during our business hours.
          </p>
        </div>
            ...
            >
              ...
              <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                <p className="text-amber-800 text-sm">
                  <strong>Note:</strong> We recommend scheduling appointments in
                  advance to ensure our team is available to meet with you.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Our contemporary office in Mumbai provides a collaborative
                  environment where innovation meets social impact. Equipped
                  with modern amenities and meeting facilities.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <p className="mb-6 opacity-90">
                Want to meet our team in person? We'd love to show you around
                our office and discuss how we can work together to create
